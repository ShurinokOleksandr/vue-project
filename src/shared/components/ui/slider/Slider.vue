...
import { useForwardPropsEmits, SliderRange, SliderThumb, SliderTrack, SliderRoot } from 'radix-vue'
import { cn } from '@/lib/utils';
import { computed } from 'vue'

const props = defineProps<{ class?: HTMLAttributes['class'] } & SliderRootProps>()
